class CLI
  ...
  def surf
    puts "  "
    puts ">>>>---------------- ·÷±‡± Welcome to MarketingEvents ±‡±÷· ---------------->".colorize(:blue)
    puts "                     your guide to our partners' events ".colorize(:cyan)
    puts "  "
    list_continents
  end
  ...
  def list_continents
    ...
    puts "Select Organization: (Enter number or exit)".colorize(:blue)
